 ...
 */
public class OtherType1 extends LinearLayout implements View.OnClickListener,View.OnLongClickListener{
    ...
    public OtherType1(Context context) {
        super(context);
        // 将自定义组合控件的布局渲染成View
        initview(context);
    }
    public OtherType1(Context context, AttributeSet attrs) {
        super(context, attrs);
        initview(context);
    }
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch(item.getItemId()){
                    case R.id.action_open:
                        ...
                        cha2.setText("no need to set this channel");
                        cha2.setTextSize(15);
                        cha2.setTextColor(0xFF969696);
                        cha2.setEnabled(false);
...
// 如何处理灯的开关，需要参数，1.灯位置 2.灯类型，是什么样的灯，如果是开灯，就关灯，如果是关灯就开灯，
    public void HandleLightOnoff(int waitSendValue) {
        ...
        try {
            ...
            intChns = othercontent.channel_1;
            // 执行开关灯
            if (oc.SingleChannelControl(byteSubnetID, byteDeviceID,
