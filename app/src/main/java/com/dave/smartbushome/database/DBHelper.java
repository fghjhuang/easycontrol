...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "sbus.db3";
    private static final int DATABASE_VERSION = 3;
    private static  String DATABASE_PATH=Environment.getExternalStorageDirectory().getPath()+"smartbus/database";
