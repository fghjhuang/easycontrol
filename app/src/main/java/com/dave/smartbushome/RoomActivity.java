...
import com.dave.smartbushome.assist.Adapter.FounctionAdapter;
import com.dave.smartbushome.assist.DraggableGridViewType2;
...
public class RoomActivity extends AppCompatActivity {
    ...
    String[] founction_count={"0","0","0","0","0","0","0","0","0"};//light,ac,fan,curtain,music,mood,other,media,nio
    @Override
    ...
    final String[] mItems = {"Light", "HVAC","Fan", "Curtain","Music","Mood","Other","Media","9 in 1"};
    @Override
        ...
        public void onItemClick(Object o,int position) {
            if(position==-1){
                ...
                if (t == 0) {
                    ...
                    MainActivity.mgr.updateroom(roominfo, mItems[position].toLowerCase());
                    handlefc.postDelayed(getfc,20);
                } else {
