...
import com.dave.smartbushome.selflayout.AudioInLayout;
import com.dave.smartbushome.selflayout.MusicLayout;
import com.dave.smartbushome.selflayout.RadioLayout;
...
public class Music extends Fragment implements View.OnClickListener {
    ...
    public void shakeperform(int shaketype){
        switch (shaketype){
            case 1:zaudiocontrol.MusicControl((byte) 4, (byte) 1, (byte) 0, (byte) 0, (byte) thismusic.subnetID, (byte) thismusic.deviceID,MainActivity.mydupsocket);break;
            case 2:zaudiocontrol.MusicControl((byte) 4, (byte) 2, (byte) 0, (byte) 0, (byte) thismusic.subnetID, (byte) thismusic.deviceID,MainActivity.mydupsocket);break;
            case 6:
                if(playorpause==0){
