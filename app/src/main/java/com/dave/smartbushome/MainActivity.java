...
import com.dave.smartbushome.assist.nfc.NFCRun;

import com.dave.smartbushome.assist.scheduleutil.ScheduleRestartService;
import com.dave.smartbushome.assist.scheduleutil.ScheduleServer;
import com.dave.smartbushome.database.DBManager;
import com.dave.smartbushome.database.Savenfc;
...
public void initcreate(){
    ...
    if(!this.isWorked("com.dave.smartbushome.ScheduleServer")){
        Intent service=new Intent(this, ScheduleServer.class);
        startService(service);
        Intent service2=new Intent(this, ScheduleRestartService.class);
        startService(service2);
...
private  void buttonitemInit(){
        ...
        public void onTabSelected(int position) {//未选中 -> 选中
            ...
            switch (position) {
                case 0:
                    ...
                    toolbar.setBackgroundColor(getResources().getColor(R.color.mainpage));
                    if (Build.VERSION.SDK_INT >= 21) {
                        window.setStatusBarColor(getResources().getColor(R.color.mainpage));
                    }
                    break;
                case 1:
                    ...
                    toolbar.setBackgroundColor(getResources().getColor(R.color.tool));
                    if (Build.VERSION.SDK_INT >= 21) {
                        window.setStatusBarColor(getResources().getColor(R.color.tool));
                    }
                    break;
            }
            transaction.commit();
    ...
    mainpage.setActiveColor("#00067c").setInActiveColor("#727272");
    BottomNavigationItem toolitem=new BottomNavigationItem(R.mipmap.ic_launch_white_24dp, "Center");
    toolitem.setActiveColor("#D58402").setInActiveColor("#727272");
