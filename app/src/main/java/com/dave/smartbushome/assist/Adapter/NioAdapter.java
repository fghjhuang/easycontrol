...
import com.dave.smartbushome.database.Savenio;
 ...
 */
public class NioAdapter extends BaseAdapter{
    private Context context;
    private List<Savenio> buttonarray=new ArrayList<Savenio>();
    private int size;
    private LayoutInflater inflater=null;
    private HashMap<Integer, View> mView ;
    private String[] colorarray={"FF2176BC", "FF8E4E87","FFB62F32","FF7BC176","FFEB6A68","FFF08519","FFFAC65A"};
    public NioAdapter(final Context context, List<Savenio> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(view==null)
        {
            ...
            txt.setText(buttonarray.get(position).nio_remark);
    ...
    public Savenio getselected(int position){
        return buttonarray.get(position);
    }
