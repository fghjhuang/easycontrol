 ...
 */
public class LightTypeAdapter extends BaseAdapter{
    private Context context;
    private List<String> stringarray=new ArrayList<String>(){
        {
            add("light_type1");add("light_type2");add("light_type3");add("light_type4");
        }
    };
    private List<String> namearray=new ArrayList<String>(){
        {
            add("light Switched");add("light Variable");add("light LED");add("light Press");
        }
    };
    private int size;
    private LayoutInflater inflater=null;

    public LightTypeAdapter(final Context context){
