 ...
 */
public class DraggableGridViewType2  extends ViewGroup {
    ...
    private static final int DEFAULT_GRID_GAP = 20; // gap between grids (dips)
    ...
    private static final long EDGE_HOLD_DURATION = 700; // ms
    ...
    public DraggableGridViewType2(Context context) {
        super(context);
        initDraggableGridViewPager();
    }

    public DraggableGridViewType2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initDraggableGridViewPager();
    }

    public DraggableGridViewType2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initDraggableGridViewPager() {
        ...
        //mColCount = ((px2dip(context,w_screen)-mGridGap)/(93+mGridGap));
        //mRowCount =((px2dip(context,h_screen)-mGridGap)/(93+mGridGap)) ;
        // internal paddings
